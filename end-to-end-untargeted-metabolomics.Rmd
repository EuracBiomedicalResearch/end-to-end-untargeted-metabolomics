...
plot(eic_Met, main = "1- Methylhistidine", col = paste0(col_sample, 80))
grid()
legend("topright", col = col_phenotype,
       legend = names(col_phenotype), lty = 1)
```

... describe EICs - for cytine there is a clear concentration difference between
...
#' Full EIC
eics <- chromatogram(data, mz = as.matrix(intern_standard[, c("mzmin", "mzmax")]))

dr <- "png/internal_standard/chromatogram/"
dir.create(dr, recursive = TRUE, showWarnings = FALSE)
for (i in seq_len(nrow(intern_standard))) {
    png(paste0("png/internal_standard/chromatogram/chromatogram_",
               intern_standard$abbreviation[i], ".png"),
...
#' - Histidine: very nice signal, RT a bit off.
...
param <- CentWaveParam(peakwidth = c(1, 8), ppm = 15, integrate = 2, snthresh = 5)
...
plot(Met_test, main = "1- Methylhistidine", col = paste0(col_sample, 80),
...
plot(eic_Met, main = "EIC 1- Methylhistidine", col = paste0(col_sample, 80),
...
Use another ion as example... seems that around a rt of 150 there was stronger
adjustment? potential compounds to check, maybe the internal standards for:
- leucine
- methionine
- phenylalanine
