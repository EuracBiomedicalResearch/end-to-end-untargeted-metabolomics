...
Whether or not a specific bias is present in the data or how strong its impact
on the data is, needs to be evaluated on a data set basis. Proper planning of an
