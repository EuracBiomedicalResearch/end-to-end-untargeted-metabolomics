...
Let's build a bpc for the quality control samples and observe the retention time shift.
```{r}
bpc_raw <- data[c(1,4,7,10)] |>
  chromatogram(aggregationFun = "max")

plot(bpc_raw, peakType = "none")
#put all samples, but hange color of non QC is less visible 
```
Here we can see some small shift between the different quality control samples. 
