...
next step in the data preprocessing pipeline, correspondence.
...
These preprocessing steps result in a two-dimensional matrix with abundances of
...
Now, let's extract the results of the preprocessing:
...
preprocessing steps. The object contains the feature definitions, the feature
