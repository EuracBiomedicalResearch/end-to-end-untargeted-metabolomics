...
high dimensionality of the data, and the presence of noise and artifacts. (H. Gika, 2014)
...
particular disease to reduce the risk of heart arrhythmias.(But CVD patients had lower abundance of this ion then when compared with control group: FT0845 had a fold change of -6.334. Since caffeine was decreased on the disease group, doesn`t seem that our data tells us that the disease is related to caffeine consumption (Although it does make sense biologically). Also is though to make good conclusion from such analysis, so I would replace this alst sentence by something like "but a probable life-style property that separate disease group from controls")
