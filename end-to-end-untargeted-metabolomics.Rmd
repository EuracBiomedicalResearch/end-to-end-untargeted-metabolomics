...
set [anna: I think this definition should be given at the beginning (see my previous comment)]. 
...
detail in the next section. [anna: I think this
is not needed; it's immediately after this line and it's pretty clear. in more
detail in the following section.] For our dataset, we use small values for
